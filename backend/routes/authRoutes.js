...
// const { sendOtpHandler } = require('../controllers/otpController'); // Import sendOtpHandler (no longer needed)
...
// router.post('/send-otp', catchAsync(sendOtpHandler)); // Remove this route
