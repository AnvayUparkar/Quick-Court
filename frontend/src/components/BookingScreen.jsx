...
const BookingScreen = () => {
    ...
    const handleConfirmBooking = () => {
        ...
        // Save booking data to session storage for payment screen
        const bookingData = {
            venue: venue.name,
            sport: venue.sport,
            court: selectedCourt,
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Do you want to proceed to payment and confirm your booking?
                        </p>
                        <div className="flex gap-4">
                            <button
                                ...
                                className="flex-1 bg-emerald-600 text-white py-3 rounded-lg hover:bg-emerald-700 transition duration-200"
                            >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-2xl font-bold text-emerald-600">QUICKCOURT</h1>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <h2 className="text-3xl font-bold mb-6">Court Booking</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-xl font-semibold">{duration}hr</span>
                                <button
                        ...
                        <button
                            ...
                            className="w-full bg-emerald-600 text-white py-4 rounded-lg font-semibold hover:bg-emerald-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition duration-200"
                        >
                            ...
                            <div className="grid grid-cols-7 gap-1">
                                {days.map((date, index) => (
                                    <button
                                        ...
                                        className={`p-2 text-sm rounded-lg transition duration-200 ${!date
                                                ? "invisible"
                                                : date < new Date()
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold">{selectedCourt || "Not selected"}</span>
                                </div>
