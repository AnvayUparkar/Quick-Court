...
const VenueDetailsPage = () => {
    ...
    const [reviews, setReviews] = useState([]); // State to store reviews for this facility
    ...
    const facilityReviews = facility && globalReviews ? globalReviews.filter((r) => r.facilityId === facility._id) : [];
