...
const CourtManagementPage = () => {
    ...
    const [timeSlotFormData, setTimeSlotFormData] = useState({ startDate: '', endDate: '', startTime: '', endTime: '' });
    ...
    const handleRemoveTimeSlot = async (courtId, slotId) => {
